...
A selection of the static figures generated by the batch analysis pipeline
(`src/eda.py`, `evaluation.py`, `sensitivity.py`, `real_data.py`); the full
set of 15 figures is in `results/figures/`.
