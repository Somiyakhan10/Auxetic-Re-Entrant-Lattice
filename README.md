...
| | |
|---|---|
| ![Distributions](results/figures/01_distributions.png) | ![Correlation heatmap](results/figures/02_correlation_heatmap.png) |
| Distribution of geometry parameters and predicted properties across the 2,562-sample analytical dataset. | Correlation between unit-cell geometry and effective mechanical properties. |
| ![3D surface](results/figures/04_geometry_property_surface.png) | ![Analytical model comparison](results/figures/05_model_comparison.png) |
| 3D surface of Poisson's ratio over cell angle and h/l ratio, with the auxetic boundary contoured in red. | Cross-validated R² across four surrogate models for all four analytical targets. |
| ![Feature importance](results/figures/08_feature_importance.png) | ![PLA vs ABS comparison](results/figures/12_real_material_pattern_comparison.png) |
| Permutation feature importance — cell angle and h/l ratio dominate auxetic behavior. | Measured tensile strength, elongation, and roughness for PLA vs. ABS across grid and honeycomb infill. |
| ![Real process vs strength](results/figures/13_real_process_vs_strength.png) | ![Real model comparison](results/figures/14_real_model_comparison.png) |
| Real FDM process parameters (infill density, print speed) plotted against measured PLA tensile strength and elongation. | Cross-validated model comparison on the real Kaggle dataset (n = 69). |
